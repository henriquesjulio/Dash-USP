...
BACKGROUND_RADAR = 'rgba(252,180,33, 1)'  
LINHA_X = 'white'
LINHA_Y = 'white'
...
LINHA_EVOLUCAO_PATRIMONIAL = 'rgba(252,180,33, 1)' 
LISTA_DE_CORES_LINHAS = ['rgba(148, 90, 56,1)', 'rgba(252,180,33, 1)', 'rgba(76,0,176,0.4)', 'rgba(138,0,176,0.4)', 'rgba(103,0,103,0.4)', 'rgba(87,53,106,0.4)', 'rgba(177,0,205,0.4)', 'rgba(190,46,214,0.4)', 'white']
HOVER_LINE_GRAPH = {
        "bgcolor":"rgba(32, 36, 73, 0.7)",
        "font" : {'color':COR_LEGENDA}
}
PREENCHIMENTO_LINE_GRAPH = 'rgba(252,180,33, 0.1)'


CARD_GRAPHS_LINE_COLOR = 'rgba(252,180,33, 0.5)'
